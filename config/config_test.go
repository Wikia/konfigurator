...
var _ = Describe("Config", func() {
	Context("with sample variable configuration", func() {
		...
		expectedDefinitions := []interface{}{
			...
			model.VariableDef{Name: "bar", Value: "key2", Type: model.INLINE, Source: model.CONSUL, Context: map[string]string{}},
			model.VariableDef{Name: "simple", Value: "key3", Type: model.INLINE, Source: model.SIMPLE, Context: map[string]string{}},
			model.VariableDef{Name: "config", Value: "key6", Type: model.CONFIGMAP, Source: model.SIMPLE, Context: map[string]string{}},
			model.VariableDef{Name: "inline", Value: "key7", Type: model.INLINE, Source: model.SIMPLE, Context: map[string]string{}},
			...
			model.VariableDef{Name: "layered", Value: "key6", Type: model.INLINE, Source: model.LAYERED_CONSUL, Context: map[string]string{"appname": "sample_app", "environment": "development"}},
		}
